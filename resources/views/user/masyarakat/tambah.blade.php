    ...
    <div class="flex-1 overflow-x-hidden overflow-y-auto p-6 md:p-8 scrollbar-hide">
        ...
        <div class="bg-white rounded-xl  overflow-x-hidden overflow-y-auto shadow-lg  w-full p-8 md:p-10">
            ...
            <div class="mb-8 text-center md:text-left">
                <h1 class="text-3xl font-bold text-gray-800">Tambah Data Penjualan</h1>
                <p class="text-gray-500 mt-1">Masukkan data penjualan beras untuk pendataan</p>
            </div>

            <form action="{{ route('user.tambah.masyarakat.process') }}" class="space-y-6" method="post"
